      ...
      44: function(e, t) {
          ...
          var o = function(e) {
              ...
              function r(t) {
                  ...
                  return ["digital-subscriber"].some(function(e) { // that can be interesting
              ...
              function s(seg) {
                          ...
                          var t;
                          if(e.inArray("Not Subscriber", seg) >=0){
                                console.log("if:=======>");
                                t = EV.util.getEVSession() ? '<a href="https://www.newstatesman.com/subscribe12" id="new_sub_button" class="last leaf menu-mlid-12703 subscribe-link navLoggedIn homepageSUBS">Subscribe</a> <a href="/my-account" class="navLoggedIn">My Account</a>  <a class="navLoggedIn" onclick="javascript:EV.Core.UI.logout();">Log out</a>' : '<button name="login" class="tns-btn tns-login" >Login</button>  <button name="register" class="tns-btn tns-register">Register</button><a href="https://www.newstatesman.com/subscribe12" id="new_sub_button" class="last leaf menu-mlid-12703 subscribe-link homepageSUBS">Subscribe</a>', e(".tns-evo-profile").html(t), console.log(t)
                          }else if(e.inArray("digital-subscriber", seg) >=0){
                                console.log("Else if:=======>");
                                t = EV.util.getEVSession() ? '<a href="/my-account" class="navLoggedIn">My Account</a>  <a class="navLoggedIn" onclick="javascript:EV.Core.UI.logout();">Log out</a>' : '<button name="login" class="tns-btn tns-login" >Login</button>  <button name="register" class="tns-btn tns-register">Register</button><a href="https://www.newstatesman.com/subscribe12" id="new_sub_button" class="last leaf menu-mlid-12703 subscribe-link">Subscribe</a>', e(".tns-evo-profile").html(t), console.log(t)
                          }else{
                                console.log("Else:=======>");
                                t = EV.util.getEVSession() ? '<a href="/my-account" class="navLoggedIn">My Account</a>  <a class="navLoggedIn" onclick="javascript:EV.Core.UI.logout();">Log out</a>' : '<button name="login" class="tns-btn tns-login" >Login</button>  <button name="register" class="tns-btn tns-register">Register</button><a href="https://www.newstatesman.com/subscribe12" id="new_sub_button" class="last leaf menu-mlid-12703 subscribe-link homepageSUBS">Subscribe</a>', e(".tns-evo-profile").html(t), console.log(t)
                          }
                        ...
                        var ukSubPage = "/subscribe12";
                          var intSubPage = "/int-subscribe";
  
                          if(location == 'UK') {
                                console.log("If condition");
                                $("#new_sub_button").attr("href", ukSubPage);
                                $("#new_sub_button_mobile").attr("href", ukSubPage);
                          } else {
                                console.log("Else condition");
                                $("#new_sub_button").attr("href", intSubPage);
                                console.log("Else condition:==>", $("#new_sub_button"));
                                $("#new_sub_button_mobile").attr("href", intSubPage);
                          }
                          $("#new_sub_button_mobile").hide();
              }
              ...
              return {
                  init: function() {
                      (o.hasClass("node-type-blogs") || o.hasClass("node-type-longread")) && (i = !0), EV.util.getEVSession() || o.hasClass("ev-is-anon") ? EV.util.getEVSession() && (o.addClass("ev-is-loggedin"), o.hasClass("node-type-blogs") || o.hasClass("node-type-longread") || EV.Em.segment("{}", function(e) {
                          ...
                          c(this)
                      }), l(".tns-modal--register"), EV.Event.on("ev.registration.loaded", l), EV.Em.segment("{}", function(e) {
                          //r(e.segments),
                                      //var seg = e.segments
                                      s(e.segments)
                      }, function(e) {
                          return e
                      }), e("body.ev-is-loggedin .mobile-login-container .ev-myaccount button.tns-login").on("click", function() {
          ...
          (function(e) {
              ...
              function r(n) {
                          localStorage.setItem("site_url", jQuery("#old_url").val());
                  var r;
              ...
              function c(e) {
                  i("return") ? EV.Event.publish(EV.Event.LOGIN_SUCCESS) : i("id") && i("productName") ? EV.Event.publish(EV.Event.LOGIN_SUCCESS) : i("register") && EV.Event.publish(EV.Event.LOGIN_SUCCESS), o.hide(), alert("Please check your email to verify your account"), console.log("registraion Success")
              }
              ...
              return EV.Event.on(EV.Event.PM_PAYMENT_TYPE_ENFORCE, function(e) {
                  ...
                  init: function() {
                      ...
                      //New custom code started.
                      EV.Event.on(EV.Event.PM_PRODUCT_ACTION, function () {
                         console.log('pm.productaction') 
                      })
                      //end custom code.
                      EV.Event.on("login.success", r), EV.Event.on("social-login.success", r), EV.Event.on("login.failed", l), EV.Event.on("registration.success", c), EV.Event.on("social-register.success", c), EV.Event.on("registration.failed", d), EV.Event.on("event_to_listen", u), EV.Event.on("logout.action", p), EV.Event.on(EV.Event.SOCIAL_LOGIN_FAILED, v), EV.Event.on(EV.Event.SOCIAL_REGISTER_FAILED, v), EV.Event.on("reset-password.success", s), EV.Event.on("login_loaded", function() {
                      ...
                      }), e('ev-registration input[name="last_name"]').keyup(function(event){
                                      console.log("Key Press and UP")
                                }),
                          ...
                          o.val() ? o.parent().next(".rvalidation").remove() : 0 == o.parent().next(".rvalidation").length && o.parent().after("<div class='rvalidation col-sm-12'>Please enter password</div>"), a.val() ? a.val() != o.val() ? 0 !== a.val() && (a.parent().next(".rvalidation").remove(), console.log("Password is not matching"), 
                          a.parent().after("<div class='rvalidation col-sm-12'>Your password and confirmation password does not match</div>")) : (a.parent().next(".rvalidation").remove(), console.log("removed")) : 0 == a.parent().next(".rvalidation").length && a.parent().after("<div class='rvalidation col-sm-12'>Please enter confirm password</div>"), 
                          i.val() ? i.val().length < 2 ? 0 == i.parent().next(".rvalidation").length && i.parent().after("<div class='rvalidation col-sm-12'>Please enter minimum 2 characters in first name</div>") : i.parent().next(".rvalidation").remove() : 0 == i.parent().next(".rvalidation").length && i.parent().after("<div class='rvalidation col-sm-12'>Please enter valid first name</div>"), 
                      ...
                      }), EV.Event.on(EV.Event.ACC_ACTIVATION_SUCCESS, function() {
                          console.log("activated.");
                          // alert("Your account is acctivated");
                          var url = localStorage.getItem("site_url");
                                      // alert(url);
                          if(url !== 'undefined' && url !== null){
                                            // alert('If condition');
                              window.location.href =localStorage.getItem("site_url")
                          }else{
                          ...
                          console.log("pm.redirectToLogin")
                          ...
                          console.log("Product selected"),
                              function(t) {
                                                  console.log(t)
                                                  var ptrail = (t == "Free_Trial_digital_4weeks_LabourPartyConference") ? 0 : -1
                                                  //console.log(ptrail)	
                                  var n = ["PRINT_DIGITAL_12412_JUNE2020_INSERTCARDS","PRINT_12412_JUNE2020_INSERTCARD","DIGITAL_12412_JUNE_2020_INSERTCARD","print_12for12_quarterly", "print_digital_12for12_", "12for12_digital", "print_12for12_quarterly_new", "12for12_digital_new", "print_digital_12for12_new", "insert_print_only_12for12","12412print_plus_Greta_book_insert"].concat(["12for12_print_only_student", "print_digital_student_12for12", "12for12_digital_student","ELECTION19_12_for_12_print","ELECTION19_12_for_12_bundle","ELECTION19_12_for_12_digital","CLF_APRIL2020_12_for_12_print","CLF_APRIL2020_12_for_12_print_digital","CLF_APRIL2020_12_for_12_digital, 12412print_plus_WarDoc_book_insert"]);
                                  ...
                                  try {
                                      ...
                                      console.log("DD plan error")
                                                  ...
                                                  -1 !== e.inArray(t, n) ? (e("ev-stripe").css("display", "none"), /*e("ev-request-directdebit-mandate").css("display", "block"),*/ e("ev-gocardless").css("display", "block"), EV.Event.publish(EV.Event.PM_PAYMENT_TYPE_ENFORCE, EV.Event.PM_PAYMENT_TYPE.DIRECT_DEBIT), TNS_Data.paymentType = EV.Event.PM_PAYMENT_TYPE.DIRECT_DEBIT) : ( e.inArray(t, n) == ptrail ? (e("ev-stripe").css("display", "block"), /*ee("ev-request-directdebit-mandate").css("display", "none"),*/e("ev-gocardless").css("display", "none"), EV.Event.publish(EV.Event.PM_PAYMENT_TYPE_ENFORCE, EV.Event.PM_PAYMENT_TYPE.CARD), TNS_Data.paymentType = EV.Event.PM_PAYMENT_TYPE.CARD) : (e("ev-manual").css("display", "block"), e("ev-stripe").css("display", "none"), e("ev-request-directdebit-mandate").css("display", "none"),  EV.Event.publish(EV.Event.PM_PAYMENT_TYPE_CHANGED, "CASH"), TNS_Data.paymentType = EV.Event.PM_PAYMENT_TYPE.CASH))
                              }(t[0].paymentPlan.name), e("#accordion").accordion("option", "active", 1), a(), n = !1, m("#accordion .step-1-1")
                      }), EV.Event.on(EV.Event.PM_REDIRECT_ORDER_SUMMARY, function(s) {
                          console.log(s)
                          console.log("pm.redirectOrderSummary")
                          ...
                          //Redirect old code.
                          // var pname = getParameterByName('productName')
                          // // console.log(getParameterByName('productName'))
                          // if(pname == "Free_Trial_digital_"){
                          //     alert('Thank you! We hope you enjoy your free trial to the New Statesman.')
                          //     window.location.href = "/"
                          // }
                      }),
                      // EV.Event.on(EV.Event.PM_PRODUCTS_SELECTED, function(t){
                      //     console.log('product selected2')
                      //     console.log(t)
                      // }),
                      EV.Event.on(EV.Event.PM_CREATE_ORDER_SUCCESS, function(t) {
                          console.log('order success')
                          // console.log(t)
                          var pname = getParameterByName('productName')
                          console.log(getParameterByName('productName'))
                          if(pname == "Free_Trial_digital_"){
                               e("ev-manual").css("display", "block"), e('button.manual-submit-btn').html('Confirm Order'),e("button.product-profile-submit-btn").css("display", "none")
                          } else{
                          ...
                          // EV.Event.publish(EV.Event.PM_PAYMENT_TYPE_CHANGED, "CASH")
                      }),
                      EV.Event.publish(EV.Event.PM_REDIRECT_TO_PAYMENT, function(){
                          console.log("pm.redirectToPayment")
                      }), 
                      EV.Event.publish(EV.Event.PM_REDIRECT_TO_MANUAL_PAYMENT, function(){
                          console.log("pm.redirectToManualPayment")
                      }), 
                      EV.Event.publish(EV.Event.PM_PAYMENT_TYPE_CHANGED, function(){
                          console.log("pm.paymentTypeChanged")
                      }),
                      EV.Event.on(EV.Event.PM_PAYMENT_SUCCESS, function() {
                          console.log('payment succeess')
                           ...
                           console.log(getParameterByName('productName'))
                           if(pname == "Free_Trial_digital_"){
                               e("ev-error-msg").css("display", "none")
                               alert('Thank you! We hope you enjoy your free trial to the New Statesman.')
                           }                        
                          ...
                          el ? (document.cookie = "subsRefererPage=; expires=Thu, 01 Jan 1970 00:00:01 GMT;", window.location.href = el) : window.location.href = "/"
                      }), e("#accordion").on("click", ".profilepage", function(n) {
                          //Redirect old code.
                          var pname = getParameterByName('productName')
                          console.log(getParameterByName('productName'))
                          if(pname == "Free_Trial_digital_"){
                              e("ev-manual").css("display", "none")                            
                          }                        
